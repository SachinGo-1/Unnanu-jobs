...
class DownloadPopup extends Component {
  ...
  handleScroll = () => {
    ...
    if (!isMobile && !isLogged && !cookies.token) {
  ...
  render() {
    return (
      <div className="sign-in-up-alert" ref="downloadPopup">
        <header>
          <img
            src="/static/banners/download-on-mobile.jpg"
            srcSet="/static/banners/download-on-mobile@2x.jpg 2x, /static/banners/download-on-mobile@3x.jpg 3x"
          />
          <button onClick={this.dismissModal}>
            <svg width="22px" height="22px" viewBox="0 0 22 22" version="1.1">
              ...
              >
                <g
                  id="un-jobpage-job-board---appdownloadpopover"
                  transform="translate(-1408.000000, -579.000000)"
                >
                  <g
                    id="Group-5"
                    transform="translate(1082.000000, 545.000000)"
                  >
        ...
        <div className="alert-body">
          ...
          <div className="alert-apps d-flex justify-content-center">
            <a
              href="https://itunes.apple.com/us/app/unnanu/id1172255010?mt=8"
              target="_blank"
            >
              <img
                src="/static/banners/alert-ios.png"
                srcSet="/static/banners/alert-ios@2x.png 2x, /static/banners/alert-ios@3x.png 3x"
              />
            </a>
            <a
              href="https://play.google.com/store/apps/details?id=com.unnanu.app&hl=en_US"
              target="_blank"
            >
              <img
                src="/static/banners/alert-android.png"
                srcSet="/static/banners/alert-android@2x.png 2x, /static/banners/alert-android@3x.png 3x"
              />
            </a>
          </div>
        </div>
...
export default withRedux(Store, mapStateToProps)(withReduxSaga(DownloadPopup));
