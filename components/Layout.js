...
const Layout = (props) => (
  <div className="viewport d-flex flex-column h-100">
    <Head>
      ...
      <meta property="og:site_name" content="Unnanu Job Board" />
      <meta property="og:type" content="website" />
      <meta name="twitter:title" content="Unnanu" />
      <title>
        {" "}
        {props.title !== "Unnanu Job Board"
          ? `Unnanu Job Board - ${props.title}`
          : props.title}{" "}
      </title>
    </Head>
    <Header
      enableSearch={props.showSearch}
    ...
    <Notifications options={{ zIndex: 100000, top: "50px", timeout: 3000 }} />
...
Layout.defaultProps = {
  ...
  showSearch: true,
  fburl: "https://jobs.unnanu.com",
  fbtitle: "Let we find together the workplace you’ve dreamed of",
  fbdescription:
    "Have companies connect with you directly for their job applications you have submitted. Unnanu will try to match active jobs you can apply for.",
};
