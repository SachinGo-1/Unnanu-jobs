...
class Signup extends Component {
  ...
  signup = (e) => {
    ...
    const formatJobId =
      format.substring(0, format.length - applyJobID.toString().length) +
      applyJobID;
      ...
      <div className="modal-main">
        <div className="signin-popup-wrapper">
          <div className="popup-content">
            ...
            <p>
              Find your next great opportunity. Capture short videos that
              highlight your education, experience and certifications. Speak
              from the heart to share your unique achievements and experiences.
            </p>
            <button
              onClick={(e) => this.signup(e)}
              className="btn signup-button large"
            >
              Sign up for free
            </button>
            <div className="signin-link">
              ...
              <a
                href={`${
                  urls.Recruit
                }/login?service=findjobs${isJobApplied}&${queryParams}`}
              >
                Sign in.
              </a>
            </div>
            <div className="popup-footer">
              ...
              <a
                ...
                target="_blank"
                className="popup-app-store-image float-left"
              >
                <img
              ...
              <a
                ...
                target="_blank"
                className="google-play-badge float-left"
              >
                <img
...
export default withRedux(Store, mapStateToProps)(withReduxSaga(Signup));
